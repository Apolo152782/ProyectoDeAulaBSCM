                        ...
                        <div class="card bg-glass">
                            <div class="card-body px-4 py-5 px-md-5">
                                <form action="Validar" method="POST">
                                    <h1>Ups, correo y contraseña Incorrectos</h1><br>
                                    <!-- Boton -->
                                    <button type="button" class="btn btn-primary btn-block mb-4" onclick="window.location.href='/ProyectoDeAula/index.jsp'">
                                        Regresar al inicio
                                    </button>
